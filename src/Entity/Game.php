...
class Game
{
    ...
    public function __construct()
    {
        ...
        $this->publisherCN = new ArrayCollection();
    }
     ...
     * @return Collection<int, Publisher>
     */
    public function getPublisherCN(): Collection
    {
        return $this->publisherCN;
    }

    public function addPublisherCN(Publisher $publisherCN): self
    {
        if (!$this->publisherCN->contains($publisherCN)) {
            $this->publisherCN[] = $publisherCN;
            $publisherCN->addGame($this);
        }

        return $this;
    }

    public function removePublisherCN(Publisher $publisherCN): self
    {
        if ($this->publisherCN->removeElement($publisherCN)) {
            $publisherCN->removeGame($this);
        }
